...
export const logSchema: SchemaObject = {
  type: 'object', required: ['projects', 'tasks', 'actors', 'rows', 'total', 'page', 'pageSize', 'pageSizes'],
  ...
  properties: {
    ...
    rows: {
      ...
      items: {
        type: 'object', required: ['id', 'action', 'taskTitle', 'actorName', 'createdAt'], properties: {
    ...
    pageSize: { type: 'integer', description: 'Sayfa başına kayıt sayısı.', example: 10 },
    pageSizes: { type: 'array', description: 'Seçilebilir sayfa boyutları.', items: { type: 'integer' }, example: [10, 20, 50] },
  },
};
